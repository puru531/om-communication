    ...
    try {
      const invoiceData = {
        ...
        items: items.map((item) => ({
          ...
          total: Number(calculateTotal(item)),
        })),
      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              type="button"
              onClick={addItem}
              className="hidden sm:block px-4 py-2.5 bg-indigo-600 text-white text-sm rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            >
              + Add Item
            </button>
          </div>
                  ...
                  <tr key={index} className="border-t">
                    ...
                    <td className="px-3 py-2">
                      <input
                        type="text"
                        required
                        className="w-full min-w-[120px] border border-gray-300 rounded px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        value={item.itemName}
                        onChange={(e) =>
                    ...
                    <td className="px-3 py-2">
                      <input
                        ...
                        onChange={(e) =>
                          updateItem(index, "productSerialNo", e.target.value)
                        }
                      />
                    </td>
                    <td className="px-3 py-2">
                      <input
                        ...
                        min="1"
                        required
                        className="w-full max-w-[80px] border border-gray-300 rounded px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        value={item.quantity}
                        onChange={(e) =>
                    ...
                    <td className="px-3 py-2">
                      <input
                        ...
                        step="0.01"
                        required
                        className="w-full max-w-[100px] border border-gray-300 rounded px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <input
                      type="text"
                      required
                      className="w-full border border-gray-300 rounded-md px-3 py-2.5 text-base focus:outline-none focus:ring-2 focus:ring-indigo-500"
                      value={item.itemName}
                      onChange={(e) =>
                        updateItem(index, "itemName", e.target.value)
                      }
        ...
        <div className="flex justify-end pt-2">
          <button
            type="submit"
            disabled={loading}
            className="w-full sm:w-auto px-6 py-3 bg-indigo-600 text-white text-base font-medium rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50 transition-colors"
          >
